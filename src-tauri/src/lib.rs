...
pub fn run() {
    let app = tauri::Builder::default()
        ...
        .setup(|app| {
            ...
            let runtime = Arc::new(ResearchRuntime::with_native_media(
                Arc::clone(&workspace),
        ...
        .on_window_event(|window, event| {
            if window.label() == "research" && matches!(event, WindowEvent::Destroyed) {
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            research_commands::research_update_affect_state,
            research_commands::research_set_stimulus_state,
            research_commands::research_gamepad_button,
