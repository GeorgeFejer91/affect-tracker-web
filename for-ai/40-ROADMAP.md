...
- Delivered as an experimental web prototype: adaptive unrestricted touch/pen/cursor path input, speed→arousal, sustained-curvature roundness and within/cross-stroke reversal jaggedness→valence, short-stroke speed/direction continuity without lifted-gap measurement, default gated live move-until-satisfied/hold feedback plus optional direct continuous response, live 2D mapping feedback, optional normalized trace feedback, and append-only raw/derived/display CSV records.
