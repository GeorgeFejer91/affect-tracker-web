...
- Delivered: optional fullscreen physical screen calibration with 30 round reference coins across 30 currencies/regions, per-coin official provenance, two-fit 3% repeatability enforcement, display-change invalidation, browser-local persistence, and additive experiment CSV context.
