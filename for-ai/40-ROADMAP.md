...
- Delivered as an experimental desktop-browser slice: user-selected Polar H10 Web Bluetooth ECG/heart-rate acquisition, bounded live waveform/metrics, explicit independent axis mapping, and reconstructable low-rate CSV context. Physical H10 and current desktop Chromium qualification remain required; stock Meta Quest Browser and the immersive WebXR path are explicitly unsupported.
