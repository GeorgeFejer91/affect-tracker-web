...
- Delivered: optional fullscreen physical screen calibration v2 with one compact launcher; BIS shortcuts plus a searchable flag-labelled country/currency hierarchy; a static multi-denomination round-coin catalog with per-coin official provenance; mouse/trackpad/pen/touch square drawing and constrained SVG adjustment; display-change invalidation; v1 read compatibility; browser-local persistence; and additive protocol/version/country experiment CSV context.
