...
- Interactive 2D color-space coordinate selection and four persisted axis colors. The map contains a miniature live animated Flubber at the displayed coordinates, shows numeric valence/arousal, and supports pointer drag plus arrow-key movement while colors are edited.
