...
test("module uses bundled Three.js assets and contains no autonomous face clock", () => {
  ...
  assert.match(index, /phone-face-switcher-1-friendly-eyes-1-photo-dense11-1/);
  assert.match(app, /face-engines-2-matrix21-1-friendly-eyes-1-photo-dense11-1/);
  assert.match(engines, /face-model\.js\?v=matrix21-1-friendly-eyes-1/);
  assert.match(engines, /face-photo\.js\?v=dense11-warp-1/);
});
