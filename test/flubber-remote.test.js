...
test("remote pages load only the local SDK and feature code makes no microphone or audio request", () => {
  ...
  assert.match(index, /src="\.\/src\/app\.js\?v=face-engines-1-main-2-screen-calibration-module-4-mobile-party-camera-1-collaboration-9-retro-2-phone-preview-1-face-tab-1-matrix21-1"/);
